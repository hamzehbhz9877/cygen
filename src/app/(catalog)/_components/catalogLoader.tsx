...
const CatalogLoader = () => {
    return (
        <div className="container">
            <div className="w-[100%] h-[40px] mb-4 bg-[#f0f0f1] rounded ">
            </div>
            ...
            <div className={"flex justify-between"}>
                ...
                <div className={"flex-1"}>
                    ...
                    grid-cols-1 tablet:grid-cols-2 laptop:grid-cols-2 desktop:grid-cols-3 xdesktop:grid-cols-4 2xl:grid-cols-5 gap-[10px]
                     lg:gap-0">
