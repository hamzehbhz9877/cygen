...
const Loading = () => {
    return (
        <div className="container">
            <div className="all-filter w-[100%] h-[40px] mb-4 bg-[#f0f0f1] rounded dark:bg-gray-700">
            </div>
            <div className="all-filter w-[100%] h-[100px] mb-4 bg-[#f0f0f1] rounded dark:bg-gray-700">
            </div>
