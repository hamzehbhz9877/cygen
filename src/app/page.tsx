...
import AnywhereVideo from "@/components/anywhereVideo";
        ...
        <div className="home-page">
            <div className={"container flex flex-wrap lg:flex-nowrap  gap-[10px] lg:gap-[20px] my-[30px]"}>
                <div className={"w-full lg:w-[70%]"}>
                    <BannerMain ignorecontainer
                                data={banner.find(d => d.PositionSystemName === 'home_page_top_grid_right')?.AnyWherePictures}/>
                </div>
                <div
                    className={"flex-1 grid-left w-full lg:w-[0%] justify-between flex flex-row lg:flex-col gap-[10px] lg:gap-[20px]"}>
                    <BannerMain ignorecontainer
                                data={banner.find(d => d.PositionSystemName === 'home_page_top_grid_left_top')?.AnyWherePictures}/>
                    <BannerMain ignorecontainer
                                data={banner.find(d => d.PositionSystemName === 'home_page_top_grid_left_bottom')?.AnyWherePictures}
                    />
                </div>
            </div>
            <BannerMain
                data={banner.find(d => d.PositionSystemName === 'home_page_before_categories')?.AnyWherePictures}/>
            <DynamicSection
                data={dynamicSections.find(d => d.PositionSystemName === 'home_page_before_categories')?.DynamicSections}/>

            {/*<AnywhereVideo PositionSystemName={'home_page_before_categories'}/>*/}
            <Categories data={homepageCategories} />
            <BannerMain
                data={banner.find(d => d.PositionSystemName === 'home_page_before_products')?.AnyWherePictures}/>
            <DynamicSection
                data={dynamicSections.find(d => d.PositionSystemName === 'home_page_before_products')?.DynamicSections}/>
            ...
            <BannerMain
                data={banner.find(d => d.PositionSystemName === 'home_page_before_new_products')?.AnyWherePictures}/>
            <DynamicSection
                data={dynamicSections.find(d => d.PositionSystemName === 'home_page_before_new_products')?.DynamicSections}/>
            ...
            <BannerMain
                data={banner.find(d => d.PositionSystemName === 'home_page_before_best_sellers')?.AnyWherePictures}/>
            <DynamicSection
                data={dynamicSections.find(d => d.PositionSystemName === 'home_page_before_best_sellers')?.DynamicSections}/>
            <div className="container">
                {homepageProducts?.length > 0 ?
            ...
            <DynamicSection data={dynamicSections.find(d => d.PositionSystemName === 'home_page_before_news')?.DynamicSections}/>
            <div className={"container"}>
            ...
            <DynamicSection
                data={dynamicSections.find(d => d.PositionSystemName === 'home_page_before_posts')?.DynamicSections}/>
            <div className={"container"}>
